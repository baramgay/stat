...
sys.path.insert(0, 'nuristat/src')

import numpy as np
import pandas as pd
from nuristat.core.dataset import Dataset
from nuristat.core.variable import VariableMeta, MeasureType, StorageType
...
print("="*60)
from nuristat.analysis.crosstab import run_analysis as cross_run
...
print("="*60)
from nuristat.analysis.logistic_regression import run_analysis as log_run
...
print("11. 이원 분산분석")
print("="*60)
from nuristat.analysis.two_way_anova import run_analysis as twa_run
