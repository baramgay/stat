...
from nuristat.analysis.logistic_regression import run_analysis as logistic_run
from nuristat.analysis.cluster_analysis import run_analysis as cluster_run
...
class TestMultipleLogisticSPSS:
    ...
    def test_multiple_logistic_run(self, dataset_multi):
        """NuriStat 다중 로지스틱 회귀 → 결과 테이블 정상 생성."""
        spec = {
