...
class TestICCValueError:
    ...
    def test_compute_icc_value_error_adds_warning(self):
        ...
        from nuristat.analysis.icc import run_analysis as icc_run
        ...
        with patch(
            "nuristat.analysis.icc._compute_icc",
...
class TestTTestsLabelFunctions:
    ...
    def test_variable_label_used_in_output(self):
        ...
        from nuristat.analysis.ttests import run_analysis as t_run
...
class TestKendallsWZeroSSTotal:
    ...
    def test_ss_total_zero_returns_zero(self):
        ...
        from nuristat.analysis.nonparametric import _kendalls_w
...
class TestROCAUCFairGrade:
    ...
    def test_auc_fair_grade(self):
        ...
        from nuristat.analysis.roc_analysis import run_analysis as roc_run
