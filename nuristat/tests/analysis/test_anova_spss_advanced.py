...
class TestHomogeneitySPSS:
    ...
    def test_nuristat_levene_table(self):
        """NuriStat → Levene 검정 테이블 생성.
...
class TestWelchANOVASPSS:
    ...
    Python: nuristat _run_welch_anova
    """
    ...
    def test_nuristat_welch_table(self):
        """NuriStat Welch ANOVA → Welch 테이블 생성.
...
class TestTukeyHSDSPSS:
    ...
    def test_nuristat_tukey_table(self):
        """NuriStat Tukey HSD → 사후 검정 테이블 생성.
...
class TestBonferroniSPSS:
    ...
    def test_nuristat_bonferroni_table(self):
        """NuriStat Bonferroni → 사후 검정 테이블 생성.
