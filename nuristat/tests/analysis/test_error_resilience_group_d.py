...
Covers:
  - nuristat.analysis.ml_engine  (kmeans_clustering, decision_tree_classifier,
                                        linear_regression_ml)
  - nuristat.analysis.visualization.VisualizationEngine  (chart methods)
  - nuristat.analysis.result  (AnalysisResult, ResultTable)
