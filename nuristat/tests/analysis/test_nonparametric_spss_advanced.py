...
class TestFriedmanSPSS:
    ...
    def test_nuristat_friedman_result(self):
        """NuriStat Friedman → 결과 정상 생성.
...
class TestKruskalWallisSPSS:
    ...
    def test_nuristat_kruskal_result(self):
        """NuriStat Kruskal-Wallis → 결과 정상 생성.
...
class TestMannWhitneySPSS:
    ...
    def test_nuristat_mannwhitney_result(self):
        """NuriStat Mann-Whitney → 결과 정상 생성.
