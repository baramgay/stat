...
# 실행 파일 빌드
python -m PyInstaller --name NuriStat --onefile --windowed --clean src\nuristat\main.py
...
WSL에서 이미 빌드된 실행 파일:
- 위치: `/mnt/c/업무/통계패키지/nuristat/dist/NuriStat`
- 크기: 224MB
