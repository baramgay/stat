...
def _register_new_plugins(registry: AnalysisRegistry) -> None:
    ...
    new_plugins = [
        _ModulePlugin(
            ...
            module_path="nuristat.analysis.logistic_regression",
        ),
        _ModulePlugin(
            ...
            module_path="nuristat.analysis.factor_analysis",
        ),
        _ModulePlugin(
            ...
            module_path="nuristat.analysis.cluster_analysis",
        ),
        _ModulePlugin(
            ...
            module_path="nuristat.analysis.survival_analysis",
        ),
        _ModulePlugin(
            ...
            module_path="nuristat.analysis.discriminant_analysis",
        ),
        _ModulePlugin(
            ...
            module_path="nuristat.analysis.reliability",
        ),
        _ModulePlugin(
            ...
            module_path="nuristat.analysis.partial_correlation",
        ),
        _ModulePlugin(
            ...
            module_path="nuristat.analysis.roc_analysis",
        ),
        _ModulePlugin(
            plugin_id="explore",
            name="Explore",
            ...
            module_path="nuristat.analysis.explore",
        ),
        _ModulePlugin(
            ...
            module_path="nuristat.analysis.chi_square_gof",
        ),
        _ModulePlugin(
            ...
            module_path="nuristat.analysis.cohens_kappa",
        ),
        _ModulePlugin(
            plugin_id="icc",
            name="ICC",
            ...
            module_path="nuristat.analysis.icc",
        ),
        _ModulePlugin(
        ...
        _ModulePlugin(
            ...
            module_path="nuristat.analysis.bland_altman",
        ),
        _ModulePlugin(
            ...
            module_path="nuristat.analysis.sensitivity_specificity",
        ),
        _ModulePlugin(
            ...
            module_path="nuristat.analysis.two_way_anova",
        ),
        _ModulePlugin(
            ...
            module_path="nuristat.analysis.repeated_measures_anova",
        ),
        _ModulePlugin(
            plugin_id="ancova",
            name="ANCOVA",
            ...
            module_path="nuristat.analysis.ancova",
        ),
        _ModulePlugin(
            ...
            module_path="nuristat.analysis.mixed_anova",
        ),
        _ModulePlugin(
            plugin_id="manova",
            name="MANOVA",
            ...
            module_path="nuristat.analysis.manova",
        ),
        _ModulePlugin(
            ...
            module_path="nuristat.analysis.text_mining",
        ),
        _ModulePlugin(
            plugin_id="pca",
            name="PCA (주성분분석)",
            ...
            module_path="nuristat.analysis.pca",
        ),
        _ModulePlugin(
            ...
            module_path="nuristat.analysis.multinomial_logistic",
        ),
        _ModulePlugin(
