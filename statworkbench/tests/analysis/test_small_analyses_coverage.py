...
from statworkbench.analysis.normality import run_analysis as normality_run
...
class TestNormality:
    ...
    def test_var_not_found_warns(self, norm_dataset):
        ...
        with patch(
            "statworkbench.analysis.normality.prepare_analysis_frame",
        ) as mock_prep:
            import types
...
class TestFrequencies:
    ...
    def test_var_not_found_warns(self, freq_dataset):
        ...
        with patch(
            "statworkbench.analysis.frequencies.prepare_analysis_frame",
        ) as mock_prep:
            import types
            mock_result = types.SimpleNamespace(
...
from statworkbench.analysis.nonparametric import (
