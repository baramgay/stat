...
class TestRegressionModelSPSS:
    ...
    def test_statworkbench_model_summary(self):
        """StatWorkbench → Model Summary 테이블 생성.
...
class TestCoefficientsSPSS:
    ...
    def test_statworkbench_coefficients_table(self):
        """StatWorkbench → Coefficients 테이블 생성.
...
class TestMulticollinearitySPSS:
    ...
    def test_statworkbench_vif_table(self):
        """StatWorkbench → VIF 테이블 생성.
...
class TestResidualsSPSS:
    ...
    def test_statworkbench_residual_table(self):
        """StatWorkbench → 잔차 요약 테이블 생성.
