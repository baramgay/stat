...
from statworkbench.analysis.ttests import run_analysis as ttest_run, run_one_sample_ttest
...
class TestIndependentTTestSPSS:
    ...
    def test_statworkbench_ind_ttest(self):
        """StatWorkbench 독립표본 t검정 → 결과 생성.
...
class TestPairedTTestSPSS:
    ...
    def test_statworkbench_paired_ttest(self):
        """StatWorkbench 대응표본 t검정 → 결과 생성.
...
class TestOneSampleTTestSPSS:
    ...
    def test_statworkbench_onesample_ttest(self):
        """StatWorkbench 단일표본 t검정 → 결과 생성.
