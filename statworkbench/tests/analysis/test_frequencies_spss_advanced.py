...
class TestFrequenciesStatisticsSPSS:
    ...
    def test_statworkbench_freq_produces_tables(self):
        """StatWorkbench 빈도분석 → 결과 정상 생성.
...
class TestMissingValuesSPSS:
    ...
    def test_statworkbench_cat_freq_produces_tables(self):
        """StatWorkbench 범주형 빈도분석 → 결과 생성.
