...
from statworkbench.analysis.bland_altman import _compute_bland_altman
from statworkbench.analysis.cohens_kappa import _compute_kappa
...
class TestClusterSklearnUnavailable:
    ...
    def test_manual_zscore_and_kmeans_warning(self):
        ...
        import statworkbench.analysis.cluster_analysis as ca_mod
