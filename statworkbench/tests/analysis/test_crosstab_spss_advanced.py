...
class TestPearsonChiSquareSPSS:
    ...
    def test_statworkbench_produces_chi2_table(self):
        """StatWorkbench → Chi-Square 검정 테이블 생성.
...
class TestCrosstabPercentagesSPSS:
    ...
    def test_statworkbench_crosstab_tables(self):
        """StatWorkbench 교차표 → 다중 테이블 생성.
