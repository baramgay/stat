...
class TestPearsonCorrelationSPSS:
    ...
    def test_statworkbench_pearson(self):
        """StatWorkbench Pearson 상관 → 결과 생성.
...
class TestSpearmanCorrelationSPSS:
    ...
    def test_statworkbench_spearman(self):
        """StatWorkbench Spearman 상관 → 결과 생성.
...
class TestKendallCorrelationSPSS:
    ...
    def test_statworkbench_kendall(self):
        """StatWorkbench Kendall 상관 → 결과 생성.
...
class TestCorrelationMatrixInvariantsSPSS:
    ...
    def test_statworkbench_matrix_3vars(self):
        """StatWorkbench 3변수 상관행렬 → 결과 생성.
