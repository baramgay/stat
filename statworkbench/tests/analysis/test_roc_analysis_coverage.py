...
from statworkbench.analysis.roc_analysis import run_analysis, _downsample_coords
...
class TestROCValueError:
    ...
    def test_roc_value_error_adds_warning_and_continues(self):
        ...
        original_roc = __import__(
            "statworkbench.analysis.roc_analysis", fromlist=["_compute_roc"]
        )._compute_roc
        ...
        with patch(
            "statworkbench.analysis.roc_analysis._compute_roc",
