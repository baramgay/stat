...
class TestANOVASPSS:
    ...
    def test_anova_run_produces_correct_f(self, dataset):
        """StatWorkbench ANOVA → F 값이 scipy와 일치."""
        spec = {
...
class TestDescriptivesSPSS:
    ...
    def test_descriptives_run_produces_correct_mean(self):
        """StatWorkbench descriptive 분석 — scipy/SPSS와 동일한 평균 출력."""
...
class TestCorrelationSPSS:
    ...
    def test_correlation_run_produces_r(self, dataset):
        """StatWorkbench correlation → r 값이 SPSS와 일치."""
        spec = {
...
class TestUserMissingSPSS:
    ...
    def test_range_missing_values(self):
        ...
        """
        from statworkbench.analysis.assumptions import _apply_user_missing
...
class TestDecimalsSPSS:
    ...
    예제:
        ...
        StatWorkbench: format_number(35.0, 0) = "35"
    """
    ...
    def test_get_display_decimals_from_meta(self):
        ...
        from statworkbench.analysis.formatting import get_display_decimals
    ...
    def test_descriptives_output_uses_variable_decimals(self):
        ...
        from statworkbench.analysis.formatting import get_display_decimals, format_number
...
class TestPValueFormatSPSS:
    ...
    StatWorkbench format_pvalue() 동일 규칙 적용 여부 확인.
    """

    def test_very_small_p(self):
        from statworkbench.analysis.formatting import format_pvalue
