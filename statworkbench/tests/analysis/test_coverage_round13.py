...
class TestBlandAltmanException:
    ...
    def test_compute_exception_adds_warning(self):
        ...
        ds = self._ds()
        with patch("statworkbench.analysis.bland_altman._compute_bland_altman",
...
class TestChiSquareGofException:
    ...
    def test_chisquare_exception_continue(self):
        ...
        ds = self._ds()
        with patch("statworkbench.analysis.chi_square_gof.chisquare",
...
class TestDescriptiveException:
    ...
    def test_compute_exception_with_group_fallback(self):
        ...
        from statworkbench.analysis.descriptive import _compute_descriptives as orig_compute
        ...
        with patch("statworkbench.analysis.descriptive._compute_descriptives",
...
class TestPartialCorrelationExceptions:
    ...
    def test_partial_corr_matrix_exception(self):
        ...
        for c in ["x", "y", "ctrl"]:
            ds.variables[c] = _scale(c)
        with patch("statworkbench.analysis.partial_correlation._partial_corr_matrix",
...
class TestReliabilityException:
    ...
    def test_cronbach_alpha_exception_adds_warning(self):
        ...
        from statworkbench.analysis.reliability import run_analysis
        ds = self._ds()
        with patch("statworkbench.analysis.reliability._cronbach_alpha",
