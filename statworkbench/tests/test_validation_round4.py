...
class TestCrosstabAccuracy:
    ...
    def test_crosstab_cell_counts_match_pandas(self, registry, crosstab_ds):
        """StatWorkbench crosstab 셀 카운트 == pd.crosstab."""
        from statworkbench.analysis.crosstab import run_analysis as run_ct
        spec = {
        ...
        # StatWorkbench Count 테이블에는 'Total' 행·열(주변합)이 포함되므로 제외하고 비교
