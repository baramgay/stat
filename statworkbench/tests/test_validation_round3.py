...
from statworkbench.core.typing import MeasureType, MissingPolicy, StorageType
...
class TestFormattingFunctions:
    ...
    def test_format_ci_structure(self):
        ...
        from statworkbench.analysis.formatting import format_ci
    ...
    def test_format_percent_range(self):
        ...
        from statworkbench.analysis.formatting import format_percent
    ...
    def test_significance_stars_three(self):
        """p < .001 → '***'."""
        from statworkbench.analysis.formatting import add_significance_stars
