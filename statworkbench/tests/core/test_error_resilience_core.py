...
Covers:
  - statworkbench.core.dataset.Dataset
  - statworkbench.core.variable.VariableMeta
  - statworkbench.core.validation (validate_variable_name,
...
from statworkbench.core.exceptions import DatasetError, ValidationError
