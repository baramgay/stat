...
class PythonBridge:
    ...
    def __init__(self) -> None:
        self._temp_dir = tempfile.mkdtemp(prefix="statworkbench_py_")
    ...
    def execute(
        ...
        os.sys.stdout = captured_stdout
        os.sys.stderr = captured_stderr
    ...
    def _prepare_globals(self, dataset: Optional[Dataset]) -> dict[str, Any]:
        """실행 환경 전역 변수 준비."""
        import numpy as np
        import matplotlib
